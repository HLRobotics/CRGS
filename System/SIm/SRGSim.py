...
from Swarm_Robot_Guidance_SYstem import Guidance
logic=False
while(True):
    if(logic==False):
    ...
    guidance=Guidance.GuidanceMapper(True,xdir,xstep,ydir,ystep,l,b,x1,y1,x2,y2,rblb,swarm_flock_distance,xdir1,xstep1,ydir1,ystep1,Bot1x,Bot1y,xdir2,xstep2,ydir2,ystep2,Bot2x,Bot2y,xdir3,xstep3,ydir3,ystep3,Bot3x,Bot3y)
    logic=True
    print(guidance)